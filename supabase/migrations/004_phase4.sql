...
-- NOTE: Monthly leave accrual function removed - now handled by Supabase database cron job
-- to avoid double addition of leave balances (1.25 annual + 0.5 casual per month)
